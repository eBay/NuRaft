...
ptr< cmd_result< ptr< buffer > > > raft_server::send_msg_to_leader(ptr< req_msg >& req,
    ...
    if (!rpc_cli) { return cs_new< cmd_result< ptr< buffer > > >(result); }
...
void raft_server::auto_fwd_resp_handler(ptr< cmd_result< ptr< buffer > > > presult, ptr< auto_fwd_pkg > cur_pkg,
