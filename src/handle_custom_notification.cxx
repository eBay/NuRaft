...
ptr< resp_msg > raft_server::handle_custom_notification_req(req_msg& req) {
    ptr< resp_msg > resp = cs_new< resp_msg >(state_->get_term(), msg_type::custom_notification_response, id_,
...
ptr< resp_msg > raft_server::handle_out_of_log_msg(req_msg& req, ptr< custom_notification_msg > msg,
                                                   ptr< resp_msg > resp) {
    ...
    p_lv(log_lv,
         ...
         ool_msg->start_idx_of_leader_, log_store_->next_slot() - 1);
...
ptr< resp_msg > raft_server::handle_leadership_takeover(req_msg& req, ptr< custom_notification_msg > msg,
                                                        ptr< resp_msg > resp) {
    if (is_leader()) {
...
ptr< resp_msg > raft_server::handle_resignation_request(req_msg& req, ptr< custom_notification_msg > msg,
                                                        ptr< resp_msg > resp) {
    if (!is_leader()) {
