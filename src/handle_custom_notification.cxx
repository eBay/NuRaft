...
std::shared_ptr< custom_notification_msg > custom_notification_msg::deserialize(buffer& buf) {
    std::shared_ptr< custom_notification_msg > ret = std::make_shared< custom_notification_msg >();
...
std::shared_ptr< resp_msg > raft_server::handle_custom_notification_req(req_msg& req) {
    ...
    std::shared_ptr< custom_notification_msg > msg = custom_notification_msg::deserialize(*buf);
...
std::shared_ptr< resp_msg > raft_server::handle_out_of_log_msg(req_msg& req,
